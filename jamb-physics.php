...
$page_title = "JAMB Physics | " . SITE_NAME;
?>
<!DOCTYPE html>
...
<body class="bg-gray-50 text-gray-900 dark:bg-gray-900 dark:text-gray-100 transition-colors duration-300" x-data="{ 
    ...
    <header class="bg-primary-900 text-white pb-20 pt-10 px-4 rounded-b-[3rem] shadow-xl relative overflow-hidden">
        ...
        <div class="container mx-auto max-w-5xl text-center relative z-10">
            <h1 class="text-4xl md:text-6xl font-bold mb-6">Physics</h1>
            <p class="text-xl text-blue-200 max-w-3xl mx-auto mb-8">
                Mechanics, Thermal Physics, Waves and Optics, Electricity and Magnetism
            </p>
            <div class="flex flex-wrap justify-center gap-4">
                <a href="<?php echo SITE_URL; ?>/jamb-cbt.php?practice=Physics" class="bg-white text-primary-900 hover:bg-gray-100 px-8 py-3 rounded-xl font-bold shadow-lg transition flex items-center gap-2">
                    <i class="fas fa-book-open"></i> Practice Physics
                </a>
