...
$page_title = "JAMB English Language | " . SITE_NAME;
?>
<!DOCTYPE html>
...
<body class="bg-gray-50 text-gray-900 dark:bg-gray-900 dark:text-gray-100 transition-colors duration-300" x-data="{ 
    ...
    <header class="bg-primary-900 text-white pb-20 pt-10 px-4 rounded-b-[3rem] shadow-xl relative overflow-hidden">
        ...
        <div class="container mx-auto max-w-5xl text-center relative z-10">
            <h1 class="text-4xl md:text-6xl font-bold mb-6">English Language</h1>
            <p class="text-xl text-blue-200 max-w-3xl mx-auto mb-8">
                Comprehension, Lexis and Structure, Oral English, Summary Writing
            </p>
            <div class="flex flex-wrap justify-center gap-4">
                <a href="<?php echo SITE_URL; ?>/jamb-cbt.php?practice=English" class="bg-white text-primary-900 hover:bg-gray-100 px-8 py-3 rounded-xl font-bold shadow-lg transition flex items-center gap-2">
                    <i class="fas fa-book-open"></i> Practice English
                </a>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 overflow-hidden p-8">
                ...
                <div class="grid md:grid-cols-2 gap-4">
                    ...
                    $topics = [
                        ...
                        "Summary Writing",
                        "Registers and Vocabulary Development",
                        "Figures of Speech",
