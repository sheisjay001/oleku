...
<head>
    ...
    <title>JAMB Literature in English | <?php echo SITE_NAME; ?></title>
...
<body class="bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 font-sans transition-colors duration-300"
    ...
    <nav class="bg-primary-900 text-white shadow-lg sticky top-0 z-50">
        <div class="container mx-auto px-4 py-3 flex justify-between items-center">
            ...
            <div class="hidden md:flex items-center gap-6">
                <?php if (isLoggedIn()): ?>
                    <a href="<?php echo SITE_URL; ?>/dashboard/" class="hover:text-primary-200 transition">Dashboard</a>
                    <a href="<?php echo SITE_URL; ?>/jamb-subjects.php" class="font-bold text-white bg-white/10 px-3 py-1 rounded hover:bg-white/20 transition">JAMB Prep</a>
                ...
                <!-- Dark Mode Toggle -->
                <button @click="toggleTheme()" class="p-2 rounded-full hover:bg-white/10 transition-colors focus:outline-none" aria-label="Toggle Dark Mode">
                ...
                <?php if (isLoggedIn()): ?>
                    <a href="<?php echo SITE_URL; ?>/auth/logout.php" class="bg-white/10 hover:bg-white/20 px-4 py-2 rounded-lg transition text-sm font-medium">Logout</a>
                <?php else: ?>
                    <a href="<?php echo SITE_URL; ?>/auth/login.php" class="hover:text-white/80 transition text-sm font-medium">Login</a>
                    <a href="<?php echo SITE_URL; ?>/auth/get-started.php" class="bg-white text-primary-900 hover:bg-gray-100 px-4 py-2 rounded-lg transition text-sm font-medium font-bold">Get Started</a>
                <?php endif; ?>
            </div>

            <!-- Mobile Menu Button -->
            <button @click="mobileMenuOpen = !mobileMenuOpen" class="md:hidden p-2 text-white hover:bg-white/10 rounded-lg transition">
    ...
    <section class="bg-primary-900 text-white py-16 md:py-24 relative overflow-hidden">
        ...
        <div class="container mx-auto px-4 relative z-10 text-center">
            <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 tracking-tight">Literature in English</h1>
            <p class="text-xl md:text-2xl text-white/80 max-w-2xl mx-auto mb-8">Prose, Poetry, Drama, Literary Appreciation and Terms.</p>
            
            <div class="flex flex-col sm:flex-row justify-center gap-4">
                <a href="<?php echo SITE_URL; ?>/jamb-cbt.php?practice=Literature" class="bg-white text-primary-900 hover:bg-gray-100 px-8 py-3 rounded-lg font-bold text-lg transition shadow-lg flex items-center justify-center gap-2">
        ...
        <div class="container mx-auto px-4 max-w-4xl">
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700">
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    <ul class="space-y-3">
                        <li class="flex items-start gap-3 text-gray-700 dark:text-gray-300">
                            ...
                            <span>Forms of Literature: Prose, Poetry, Drama</span>
                        </li>
                        <li class="flex items-start gap-3 text-gray-700 dark:text-gray-300">
                            <svg class="w-5 h-5 text-green-500 mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                            <span>Elements of Prose</span>
                        </li>
                        <li class="flex items-start gap-3 text-gray-700 dark:text-gray-300">
                            <svg class="w-5 h-5 text-green-500 mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                            <span>Poetic Devices</span>
                        </li>
                        <li class="flex items-start gap-3 text-gray-700 dark:text-gray-300">
                            <svg class="w-5 h-5 text-green-500 mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                            <span>Drama: Acts, Scenes, Dialogue</span>
                        </li>
                        <li class="flex items-start gap-3 text-gray-700 dark:text-gray-300">
                            <svg class="w-5 h-5 text-green-500 mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                    ...
                    <ul class="space-y-3">
                        <li class="flex items-start gap-3 text-gray-700 dark:text-gray-300">
                            <svg class="w-5 h-5 text-green-500 mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                            <span>Literary Terms</span>
                        </li>
                        <li class="flex items-start gap-3 text-gray-700 dark:text-gray-300">
                            <svg class="w-5 h-5 text-green-500 mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                            <span>Literary Appreciation</span>
                        </li>
                        <li class="flex items-start gap-3 text-gray-700 dark:text-gray-300">
                            <svg class="w-5 h-5 text-green-500 mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                            <span>African Literature</span>
                        </li>
                        <li class="flex items-start gap-3 text-gray-700 dark:text-gray-300">
                            <svg class="w-5 h-5 text-green-500 mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                            <span>Genres and Movements</span>
                        </li>
                        <li class="flex items-start gap-3 text-gray-700 dark:text-gray-300">
                            <svg class="w-5 h-5 text-green-500 mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                            <span>Recommended JAMB Texts</span>
                        </li>
                    </ul>
                </div>
                ...
                <div class="mt-8 pt-6 border-t border-gray-100 dark:border-gray-700 flex flex-col sm:flex-row justify-between items-center gap-4">
                    ...
                    <a href="<?php echo SITE_URL; ?>/jamb-cbt.php?practice=Literature" class="text-primary-600 dark:text-primary-400 font-semibold hover:text-primary-700 dark:hover:text-primary-300 flex items-center gap-1 transition">
